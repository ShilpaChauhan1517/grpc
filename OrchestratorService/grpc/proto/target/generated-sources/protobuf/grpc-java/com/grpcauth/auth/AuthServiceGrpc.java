...
@javax.annotation.Generated(
    ...
    comments = "Source: auth_struct.proto")
public final class AuthServiceGrpc {

  private AuthServiceGrpc() {}

  public static final String SERVICE_NAME = "com.grpcauth.auth.AuthService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.grpcauth.auth.AuthStruct.AuthRequest,
      com.grpcauth.auth.AuthStruct.AuthResponse> getAuthenticateMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "authenticate",
      requestType = com.grpcauth.auth.AuthStruct.AuthRequest.class,
      responseType = com.grpcauth.auth.AuthStruct.AuthResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.grpcauth.auth.AuthStruct.AuthRequest,
      com.grpcauth.auth.AuthStruct.AuthResponse> getAuthenticateMethod() {
    io.grpc.MethodDescriptor<com.grpcauth.auth.AuthStruct.AuthRequest, com.grpcauth.auth.AuthStruct.AuthResponse> getAuthenticateMethod;
      ...
      synchronized (AuthServiceGrpc.class) {
        if ((getAuthenticateMethod = AuthServiceGrpc.getAuthenticateMethod) == null) {
          AuthServiceGrpc.getAuthenticateMethod = getAuthenticateMethod = 
              io.grpc.MethodDescriptor.<com.grpcauth.auth.AuthStruct.AuthRequest, com.grpcauth.auth.AuthStruct.AuthResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "com.grpcauth.auth.AuthService", "authenticate"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.grpcauth.auth.AuthStruct.AuthRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.grpcauth.auth.AuthStruct.AuthResponse.getDefaultInstance()))
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                ...
                com.grpcauth.auth.AuthStruct.AuthResponse>(
  ...
  public static final class AuthServiceBlockingStub extends io.grpc.stub.AbstractStub<AuthServiceBlockingStub> {
    ...
    /**
     */
    public com.grpcauth.auth.AuthStruct.AuthResponse authenticate(com.grpcauth.auth.AuthStruct.AuthRequest request) {
  ...
  public static final class AuthServiceFutureStub extends io.grpc.stub.AbstractStub<AuthServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.grpcauth.auth.AuthStruct.AuthResponse> authenticate(
        com.grpcauth.auth.AuthStruct.AuthRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_AUTHENTICATE:
          serviceImpl.authenticate((com.grpcauth.auth.AuthStruct.AuthRequest) request,
              (io.grpc.stub.StreamObserver<com.grpcauth.auth.AuthStruct.AuthResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class AuthServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.grpcauth.auth.AuthStruct.getDescriptor();
    }
